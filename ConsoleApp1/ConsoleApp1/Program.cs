...
namespace ConsoleApp1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            BoolVector MyVector1 = new BoolVector (5);
            MyVector1.fillRandom(); // заполняем вектор рандомно
            MyVector1.printConsole();
            // проверим тип нашего объекта
            if (MyVector1 is BoolVector) Console.WriteLine("Тип объекта - BoolVector");
            Console.WriteLine("Количество нулей в векторе : {0}", MyVector1.calcZeros());
